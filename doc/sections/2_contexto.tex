...
Los datos utilizados provienen del dataset CORD v2 \cite{avidan2022computer}, un corpus público de recibos de restaurantes coreanos e indonesios proporcionado por Naver-Clova a través de HuggingFace. El dataset contiene aproximadamente 800 muestras de entrenamiento y 100 de test y 100 de validación, cada una con la imagen del recibo y la anotación del total real (\textit{ground truth}).
